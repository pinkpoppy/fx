...
;(function($){
    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend({}, {
            ...
            domOver : {
                ...
                domLoad    : '<div class="dropload-load">没有更多数据了</div>'
            },
            distance : 50,                                                       // 拉动距离
            loadUpFn : '',                                                       // 上方function
    ...
    function fnTouchstart(e, me){
        ...
        // alert(me._loadHeight + " " + me._childrenHeight + " " + me._scrollTop);
    }
    ...
    function fnTouchmove(e, me){
        ...
        // 加载下方
        if(me.opts.loadDownFn != '' && me._childrenHeight <= (me._loadHeight+me._scrollTop + 5) && me.direction == 'up'){
            ...
            // 指定距离 < 上拉距离 < 指定距离*2
                ...
                me._offsetY = me.opts.distance+(_absMoveY-me.opts.distance)*0.5;
                if (me.isOver) {
                    me.$domDown.html('').append(me.opts.domOver.domUpdate);
                } else {
    ...
    function fnTouchend(me){
        ...
        if(me.insertDOM){
            if(me.direction == 'down'){
                ...
                if (me.isOver) {
                    me.domLoad = me.opts.domOver.domLoad;
                } else {
